                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="back-top">
                                    <a href="{{ route('sanksi.index') }}" class="btn text-muted">
                                        <i class="fa fa-arrow-left fa-fw"></i></span>
                                    </a>
                                </div>
                            </div>
                            <form action="{{ route('sanksi.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                @include('sanksi._form')
                            </form>
                            <div id="loading"></div>
                        </div>
                    </div>
