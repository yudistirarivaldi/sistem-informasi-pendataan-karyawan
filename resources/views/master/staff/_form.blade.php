<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-12 col-md-5 col-lg-5">
            <input type="number" name="nik" class="form-control @error('nik') is-invalid @enderror"
                value="{{ old('nik', $staff->nik ?? '') }}" autocomplete="off">
            @error('nik')
                <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group row">
        ...
        <div class="col-12 col-md-5 col-lg-5">
            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control select2 @error('jenis_kelamin') is-invalid @enderror">
                <option value="{{ old('jenis_kelamin', $staff->jenis_kelamin ?? '') }}">{{ old('jenis_kelamin', $staff->jenis_kelamin ?? '') }}</option>
